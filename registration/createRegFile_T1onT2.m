function createRegFile_T1onT2_MAZ01(registerFileName, fixedImage, movingImage, Tout, ImageOut, varargin)
...
[regType, regTimes] = strtok( registerFileName, '.');
